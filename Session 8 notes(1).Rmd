...
sd(wvs.dat$life.quality, na.rm = TRUE)
```
...
library(dplyr)
#wvs.dat$Ethnicity <- as.numeric(as.character(recode(wvs.dat$V254,
                                   #'1' = '5',
                                   #'2' = '4',
                                   #'3' = '3',
                                   #'4' = '2',
...
wvs.dat$occupational <- as.numeric(as.character(recode(wvs.dat$Q281,
                                   '1' = '5',
                                   '2' = '4',
                                   '3' = '3',
                                   '4' = '2',
...
wvs.dat$work_status <- as.numeric(as.character(recode(wvs.dat$V249,
                                   '1' = '5',
                                   '2' = '4',
                                   '3' = '3',
                                   '4' = '1',
...
wvs.dat$personal_security <- as.numeric(as.character(recode(wvs.dat$V170,
                                   '1' = '4',
                                   '2' = '3',
                                   '3' = '2',
                                   '4' = '1',
...
wvs.dat$class <- as.numeric(as.character(recode(wvs.dat$V236,
                                   '1' = '5',
                                   '2' = '4',
                                   '3' = '3',
                                   '4' = '2',
...
recode_to_notnull <- function(my_var) {
  scale(as.numeric(as.character(dplyr::recode(my_var,
                                               '-2' = NULL,
                                               .default = my_var))))
}
...
#wvs.dat$Ethnicity <- recode_to_notnull(wvs.dat$V254) # race discrete
wvs.dat$Education <- recode_to_notnull(wvs.dat$Q275)
#wvs.dat$occupational <- recode_to_notnull(wvs.dat$Q281) # 1-professional
#wvs.dat$work_status <- recode_to_notnull(wvs.dat$V249) #continous 1-8, 4-8 no pay
#wvs.dat$personal_security <- recode_to_notnull(wvs.dat$V170) #continous 1-4
#wvs.dat$class <- recode_to_notnull(wvs.dat$V236) #continous 1-5
wvs.dat$income <- recode_to_notnull(wvs.dat$V237)

qol=data.frame(wvs.dat$life.quality, wvs.dat$work_status, wvs.dat$personal_security, wvs.dat$class, wvs.dat$Education, wvs.dat$income)
...
```{r}
p.mat <- cor_pmat(qol, use = "complete", method = "pearson")
p.mat
```
```{r}
ggcorrplot(correlation,hc.order = TRUE, type = "lower", lab = TRUE, p.mat = p.mat, insig = "blank", sig.level = 0.5)
```
...
```{r}
quality_of_life <- lm(life.quality ~  wvs.dat$work_status + wvs.dat$personal_security + wvs.dat$class + wvs.dat$Education + wvs.dat$income, data = wvs.dat)

summary(quality_of_life )
